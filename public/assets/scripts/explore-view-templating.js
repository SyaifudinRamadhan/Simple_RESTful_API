    ...
    <div class="card rounded-3">
        ...
        <div class="card-body">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <p class="card-text fw-light">${updatedAt}</p>
            </div>
            <div class="wrapper-btn-action mt-4 row row__mod">
                <a data-bs-toggle="modal" href="#modalToogle${carID}" role="button" class="btn btn-delete border-1 d-flex align-items-center justify-content-center gap-2 fw-bold">
                ...
                <a href="${window.origin}/auth/${userID}/cars/${carID}" class="btn btn-edit border-1 d-flex align-items-center justify-content-center gap-2 fw-bold">
                    <svg width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
